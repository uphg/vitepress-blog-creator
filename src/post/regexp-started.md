...
<!-- > 先是某个单词开始处(`\b`)，然后是字母`a`,然后是任意数量的字母或数字(`\w*`)，最后是单词结束处(`\b`)。 -->

`\d+` 匹配 1 个或更多连续的数字

<t-regexp-demo :text="`123, transition, 02, family, 1`" regex="\d+"></t-regexp-demo>
...
`0\d{2}-\d{8}|0\d{3}-\d{7}` 这个表达式能匹配两种以连字号分隔的电话号码：一种是 3 位区号，8 位本地号（如`010-12345678`），一种是 4 位区号，7 位本地号（`0376-2233445`）。
...
<!-- <div class="regex-case re-part">
  <section class="regex-case-part">
    <p class="regex-case-part__title">文本内容</p>
    <div class="regex-case-part__code">
      <pre><code>&#60;article&#62;, article, &#60;audio&#62;, hallo, &#60;a&#62;</code></pre>
    </div>
  </section>
  <section class="regex-case-part">
    <p class="regex-case-part__title">正则规则</p>
    <div class="regex-case-part__code">
      <pre><code>&#60;a[^&#62;]+&#62;</code></pre>
    </div>
  </section>
  <section class="regex-case-part">
    <p class="regex-case-part__title">匹配结果</p>
    <div class="regex-case-part__code">
      <pre><code><span class="code-active">&#60;article&#62;</span>, article, <span class="code-active">&#60;audio&#62;</span>, hallo, &#60;a&#62;</code></pre>
    </div>
  </section>
</div> -->
...
<!-- <div class="regex-case re-part">
  <section class="regex-case-part">
    <p class="regex-case-part__title">文本内容</p>
    <div class="regex-case-part__code">
      <pre><code>go go, kitty kitty, give me</code></pre>
    </div>
  </section>
  <section class="regex-case-part">
    <p class="regex-case-part__title">正则规则</p>
    <div class="regex-case-part__code">
      <pre><code>\b(?&#60;Word&#62;\w+)\b\s+\k&#60;Word&#62;\b</code></pre>
    </div>
  </section>
  <section class="regex-case-part">
    <p class="regex-case-part__title">匹配结果</p>
    <div class="regex-case-part__code">
      <pre><code><span class="code-active">go go</span>, <span class="code-active">kitty kitty</span>, give me</code></pre>
    </div>
  </section>
</div> -->
...
<t-regexp-demo :text="`R1234567, r1234567, 1234567, 12345678, r12345678`" regex="(?<![a-z])\d{7}"></t-regexp-demo>
...
<!-- <div class="regex-case re-part">
  ...
  <section class="regex-case-part">
    <p class="regex-case-part__title">匹配结果</p>
    <div class="regex-case-part__code">
      <pre><code>&#60;b&#62;<span class="code-active">hello</span>&#60;/b&#62;</code></pre>
    </div>
  </section>
</div> -->
...
<style>
.regex-case:not(:last-child) {
  margin-bottom: 20px;
}
.custom-page-regex > .page > .theme-default-content code.code-word {
  white-space:nowrap;
}
</style>
